            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func1.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8"> <input type="text" class="form-control" placeholder="first name *" name="fname" onkeydown="return $fname;" required/></div><br><br>
                  <div class="col-md-4" style="margin-top: 8%"><label>Password: </label></div>
                  <div class="col-md-8" style="margin-top: 8%">  <input type="password" class="form-control" placeholder="Password *" name="password3" required/></div><br><br><br>
                </div>
                <div class="row">
